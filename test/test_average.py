...
class TestAverage(unittest.TestCase):
    ...
    def test_mode_is_sorted_for_multiple_values(self):
        self.assertEqual(average.mode([1, 2, 3, 1]), [1])

    def test_mode_is_sorted_for_multiple_values(self):
        self.assertEqual(average.mode([0]), [0])

    def test_mode_is_sorted_for_multiple_values(self):
        self.assertEqual(average.mode([3, 2, 1]), [3, 2, 1])

    def test_mode_is_sorted_for_multiple_values(self):
        self.assertEqual(average.mode([3, 3, 2, 1]), [3])
